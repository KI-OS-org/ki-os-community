...
'use strict';
// override:true — die Projekt-.env muss Vorrang vor bereits gesetzten Shell-Variablen
// haben (z.B. globales OPENAI_API_KEY in ~/.zprofile, das einen fremden Wert exportiert
// und sonst den echten Key aus .env stillschweigend ueberschreibt; Ingo-Fund 2026-08-07)
...
function createServer() {
  ...
  app.use('/api', require('../../backend/routes/voice-loop.control.routes'));
  ...
  // KIMBA Desktop-Avatar (S2 Killer-Demo) — vorproduzierte Kimba-Loops je Voice-Loop-Zustand
  app.use('/avatar', express.static(path.join(__dirname, '../../backend/public/avatar')));
